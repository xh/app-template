...
/**
 * Example implementation supports use of in-memory H2 database for initial dev/prototyping and MySQL for a properly
 * persistent database. Replace with a database configuration suitable for your app and environment.
 */
class DBConfig {
    ...
    private static void mySqlConfig(Script script) {
        withDelegate(script) {
            ...
            // Example below uses mySQL, but apps can use any DB supported by Grails (SQL Server, Postgres, etc).
            //----------------------------------------------------------------------------------------------
